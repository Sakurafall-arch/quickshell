...
Button {
    ...
    property color colBackground: Appearance.transparentize(Appearance?.colors.colLayer1Hover, 1) || "transparent"
    ...
    property color buttonColor: Appearance.transparentize(root.toggled ? 
